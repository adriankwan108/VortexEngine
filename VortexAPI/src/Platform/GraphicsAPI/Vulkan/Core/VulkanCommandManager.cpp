...
namespace vkclass
{
    ...
    void VulkanCommandManager::SetScissor(VkRect2D rect)
    {
        vkCmdSetScissor(m_mainCommandBuffers[m_currentFrame], 0, 1, &rect);
    }
    ...
    void VulkanCommandManager::TransitImageLayout(VkImage image, VkImageLayout oldLayout, VkImageLayout newLayout)
    {
        /* begin single time cmd */
        VkCommandBuffer disposbleCb;
        CreateCommandBuffer(&disposbleCb);
